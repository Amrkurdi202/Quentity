...
import com.quentity.entity.QEntity;
...
public class Student extends Entity<Student> {
    ...
    public void define(Student student) {
        ...
        currentSemesterCourses.setEntitiesWithContext(
                new ListDataProvider<>(coursesEntities == null ? new ArrayList<>() : coursesEntities),
                (context) -> {
    ...
    public StudentCourses getCurrentSemesterCourses(Student student) {
        ...
        return studentCoursesQuery.select(studentCourses).
                from(studentCourses).
                where(studentCourses.student.entity.entityId.eq(student.getEntityId()).
                        and(studentCourses.semester.entity.entityId.eq(getLatestSemester().getEntityId()))).
                limit(1).
                fetchOne();
    }
