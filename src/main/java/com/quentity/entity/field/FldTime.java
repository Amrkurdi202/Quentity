...
@Embeddable
@EqualsAndHashCode
public class FldTime extends InternalFldTime {
    ...
    @Builder
    public FldTime(LocalTime value, LocalTime minValue, LocalTime maxValue, LocalTime defaultValue, boolean required, boolean visible, boolean editable) {
